        ...
        <table class="table table-bordered border-success">
            ...
            ?>
                <tr class="text-center">
                        ...
                        <a href="Eliminar-depa.php?id=<?php echo $cliente['id'] ?>" class="btn btn-warning">Eliminar</a>
                            <a href="Editar-depa.php?id=<?php echo $cliente['id'] ?>" class="btn btn-warning">Editar</a>
                        </td>
                </tr>       
            <?php
                endforeach;
